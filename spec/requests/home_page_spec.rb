...
RSpec.describe TerrytrillaSeo::HomePage do
  ...
  describe "карточка ссылки на свою главную" do
    ...
    describe "язык страницы один" do
      ...
      # B14: с 19.09 перевод подставляется на ЛЮБОЙ странице, не только на своей
      # главной, — поэтому контроль другой: язык берётся из перевода и там, где
      # страницу рисует ядро.
      it "на главной от ядра описание тоже на языке читателя (контроль)" do
