...
#
# ⚠️ describe — КЛАСС, а не строка: rubocop ядра (RSpec/DescribeClass) на новом
# пине это отбивает, а спек с описанием строкой прошёл только потому, что пин
# отставал от боевого ядра на 68 коммитов.
#
