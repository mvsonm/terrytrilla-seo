...
| `app/views/categories/index.html.erb` + `prepend_view_path` | overrides core’s crawler view of the category list | B13: the home page a crawler gets — one H1 with the community name and a paragraph of the description in the language of the request; core’s markup is **copied into the view — compare it with core’s file on every upgrade** |
